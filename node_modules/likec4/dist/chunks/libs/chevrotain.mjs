...
`,type:J.MULTI_MODE_LEXER_WITHOUT_MODES_PROPERTY}),has(e,`modes`)&&has(e,`defaultMode`)&&!has(e.modes,e.defaultMode)&&r.push({message:`A MultiMode Lexer cannot be initialized with a ${ln}: <${e.defaultMode}>which does not exist\n`,type:J.MULTI_MODE_LEXER_DEFAULT_MODE_VALUE_DOES_NOT_EXIST}),has(e,`modes`)&&x(e.modes,(e,t)=>{x(e,(n,i)=>{if(isUndefined(n))r.push({message:`A Lexer cannot be initialized using an undefined Token Type. Mode:<${t}> at index: <${i}>\n`,type:J.LEXER_DEFINITION_CANNOT_CONTAIN_UNDEFINED});else if(has(n,`LONGER_ALT`)){let i=R(n.LONGER_ALT)?n.LONGER_ALT:[n.LONGER_ALT];x(i,i=>{!isUndefined(i)&&!A(e,i)&&r.push({message:`A MultiMode Lexer cannot be initialized with a longer_alt <${i.name}> on token <${n.name}> outside of mode <${t}>\n`,type:J.MULTI_MODE_LEXER_LONGER_ALT_NOT_IN_CURRENT_MODE})})}})}),r}function performWarningRuntimeChecks(e,t,n){let r=[],i=!1,a=reject(compact(flatten(U(e.modes))),e=>e[q]===Lexer.NA),o=getCharCodes(n);return t&&x(a,e=>{let t=checkLineBreaksIssues(e,o);if(t!==!1){let n={message:buildLineBreakIssueMessage(e,t),type:t.issue,tokenType:e};r.push(n)}else has(e,`LINE_BREAKS`)?e.LINE_BREAKS===!0&&(i=!0):canMatchCharCode(o,e.PATTERN)&&(i=!0)}),t&&!i&&r.push({message:`Warning: No LINE_BREAKS Found.
	This Lexer has been defined to track line and column information,
	But none of the Token Types can be identified as matching a line terminator.
	See https://chevrotain.io/docs/guide/resolving_lexer_errors.html#LINE_BREAKS 
	for details.`,type:J.NO_LINE_BREAKS_FLAGS}),r}function cloneEmptyGroups(e){let t={},n=u(e);return x(n,n=>{let r=e[n];if(R(r))t[n]=[];else throw Error(`non exhaustive match`)}),t}function isCustomPattern(e){let t=e.PATTERN;if(W(t))return!1;if(I(t)||has(t,`exec`))return!0;if(b(t))return!1;throw Error(`non exhaustive match`)}function isShortPattern(e){return b(e)&&e.length===1?e.charCodeAt(0):!1}const pn={test:function(e){let t=e.length;for(let n=this.lastIndex;n<t;n++){let t=e.charCodeAt(n);if(t===10)return this.lastIndex=n+1,!0;if(t===13)return this.lastIndex=e.charCodeAt(n+1)===10?n+2:n+1,!0}return!1},lastIndex:0};function checkLineBreaksIssues(e,t){if(has(e,`LINE_BREAKS`))return!1;if(W(e.PATTERN)){try{canMatchCharCode(t,e.PATTERN)}catch(e){return{issue:J.IDENTIFY_TERMINATOR,errMsg:e.message}}return!1}if(b(e.PATTERN))return!1;if(isCustomPattern(e))return{issue:J.CUSTOM_LINE_BREAK};throw Error(`non exhaustive match`)}function buildLineBreakIssueMessage(e,t){if(t.issue===J.IDENTIFY_TERMINATOR)return`Warning: unable to identify line terminator usage in pattern.
...
but found: '`+head(t).image+`'`;if(r)return`Expecting: `+r+a;{let t=reduce(e,(e,t)=>e.concat(t),[]),n=o(t,e=>`[${o(e,e=>tokenLabel(e)).join(`, `)}]`);return`Expecting: one of these possible Token sequences:\n${o(n,(e,t)=>`  ${t+1}. ${e}`).join(`
